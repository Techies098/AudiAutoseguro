                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ route('solicitudes.cambiarEstado', $solicitud->id) }}" method="POST">
                                                @csrf
                                                @method('PATCH')
                                                <button name="estado" value="en progreso" class="btn btn-warning">En Progreso</button>
                                                <button name="estado" value="aprobada" class="btn btn-success">Aprobada</button>
                                                <button name="estado" value="denegada" class="btn btn-danger">Denegada</button>
                                            </form>
                                        </td>
                                    </tr>
                                    @endforeach
