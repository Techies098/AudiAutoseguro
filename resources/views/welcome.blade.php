...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased" style="background-color: #a5d8ed;">

        <div class="bg-gray-50 text-black/50">
            {{--<img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="https://laravel.com/assets/img/welcome/background.svg" />
            <div id="background" class="absolute -left-20 top-0 max-w-[877px]" style="background-color: #87CEEB;"></div>
--}}
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <header class="grid items-center grid-cols-2 gap-2 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            {{--<img src="{{ asset('logo.png') }}" class="max-w-[10px]" alt="Logo">
                        logo fallido--}}</div>
                        @if (Route::has('login'))
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                    <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                        <img src="{{ asset('logo.png') }}" class="w-full h-auto mr-4 sm:w-64 sm:h-64" alt="Logo">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black">Seguros</h2>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Contactanos</h2>
                            ...
                            >
                                ...
                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black">Reportar Siniestro</h2>
                            ...
                            >
                                ...
                                <div class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10">
                                    ...
                                    <div class="pt-3 sm:pt-5">
                                        <h2 class="text-xl font-semibold text-black">Paga tu seguro</h2>
