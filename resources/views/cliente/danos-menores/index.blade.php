<x-app-layout>
    <x-slot name="header">
        <a href="{{ route('cliente.dano-menor.create') }}" class="btn btn-primary float-right col-sm-2">Nuevo daño menor</a>
        <h2 class="text-xl font-semibold leading-tight text-gray-800">´
            {{ __('Mi lista de reportes de daños menores') }}
        </h2>
    </x-slot>
                        ...
                        <tbody>
                            @foreach ($danos as $fila => $dano)
                                <tr>
                                    ...
                                    <td>{{ $dano->estado }}</td>
                                    <td>
                                        <a href="{{ route('cliente.dano-menor.show', $dano) }}" class="btn btn-primary">Ver</a>
